            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 sec-45">
                    <div class="white_box">
                        <div class="row">
                            <div class="drive-sec">
                                <h4 class="no-margin">Updtae Users</h4>
                            </div>
                            <form class="profile-form pad-top-40 pad-bot-20" id="resetPasswordForm" action="{{URL::to('/admin/users/update')}}" method="post">
                            @csrf
                              @if ($errors->any())
                                ...
                                <input type="hidden" name="longitude" id="long" value="{{$user->longitude}}">  --}}
                                <div class="form-row">                                    
