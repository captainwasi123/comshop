                ...
                <div class="header_iner default_header d-flex justify-content-between align-items-center">
                    ...
                    <div class="header_right d-flex justify-content-between align-items-center">
                        <div class="header_notification_warp d-flex align-items-center">
                            <li>
                                <a class="bell_notification_clicker nav-link-notify" href="#"> <img src="{{URL::to('/public/restaurant/assets')}}/images/order-noti-icon.png" alt=""></a>
                                    ...
                                    <div class="Notification_body">
                                        ...
                                        <div class="single_notify d-flex align-items-center">
                                            <div class="notify_thumb">
                                                <a href="#"><img src="{{URL::to('/public/restaurant/assets')}}/img/staf/4.png" alt=""></a>
                                            </div>
                            ...
                            <li>
                                <a href="#"> 
                                    <img src="{{URL::to('/public/restaurant/assets')}}/images/setting-noti-icon.png" alt="">
                                </a>
                            </li>
                        </div>
